...
{
	public const string UndiscoveredSummary = "Mutation: No graft has been discovered yet";
	...
	public static MutationDefinition[] Definitions { get; } =
	{
		...
		Create<SlimeEssence>(MutationId.Slime, true,
			"Mutation: Being hurt sprays weakening slime; periodically buds allied slimes",
		...
		Create<SkeletronEssence>(MutationId.Skeletron, true,
			"Mutation: Grafted hands slap distant enemies and drag them to you",
